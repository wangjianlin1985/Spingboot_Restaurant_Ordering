...
Source Database       : gp_ct

Target Server Type    : MYSQL
Target Server Version : 50620
File Encoding         : 65001

Date: 2022-09-15 14:30:42
*/
...
-- ----------------------------
INSERT INTO `rest_food` VALUES ('4', '酸菜烧仔鸡', null, '/profile/upload/2022/09/15/a73784bb51a873fa45f96b9778f81017.jpg', '32.00', '0');
INSERT INTO `rest_food` VALUES ('5', '红烧猪头肉', null, '/profile/upload/2022/09/15/60cf822eb8e90725f0064a72495ccc31.jpg', '38.00', '0');
INSERT INTO `rest_food` VALUES ('6', '红烧牛肉', null, '/profile/upload/2022/09/15/abce82c47651f13b47d79cca1c41e53d.jpg', '48.00', '0');
INSERT INTO `rest_food` VALUES ('7', '地锅鸡', '23', '/profile/upload/2022/09/15/652dbc2e2f53c07ecd862e81eb236be2.jpg', '48.00', '0');
INSERT INTO `rest_food` VALUES ('8', '雪菜烧大肠', null, '/profile/upload/2022/09/15/e6942df03f89c794c8e61ea70e8d1a96.jpg', '45.00', '0');
INSERT INTO `rest_food` VALUES ('9', '土豆烧牛肉', null, '/profile/upload/2022/09/15/e48c5fb13753dba0d7f93a3a717572ae.jpg', '38.00', '0');
INSERT INTO `rest_food` VALUES ('10', '红烧排骨', null, '/profile/upload/2022/09/15/d5b091b12d8972a8e50104acb61d3cc7.jpg', '48.00', '0');
INSERT INTO `rest_food` VALUES ('11', '咸鸭鱼头豆腐锅', null, '/profile/upload/2022/09/15/a51b8e69123373cc0a7f64a291c19f81.jpg', '80.00', '0');
INSERT INTO `rest_food` VALUES ('13', '红烧鱼', '123', '/profile/upload/2022/09/15/c8a7c05f7cedc20f7f2d69deccc8d7ba.jpg', '34.00', '0');
...
CREATE TABLE `rest_order` (
  ...
  `rockover` int(11) DEFAULT NULL,
  `date` varchar(32) DEFAULT NULL,
  `money` float(255,2) DEFAULT NULL,
  `status` int(11) DEFAULT NULL COMMENT '1进行中 2已付款 3取消',
  `type` tinyint(4) DEFAULT NULL COMMENT '1现场 2从预订转入',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB AUTO_INCREMENT=123 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='参数配置表';
...
CREATE TABLE `sys_dept` (
  ...
  `delete_flag` tinyint(4) DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=221 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='部门表';
...
) ENGINE=InnoDB AUTO_INCREMENT=130 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='字典数据表';
...
) ENGINE=InnoDB AUTO_INCREMENT=109 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='字典类型表';
...
) ENGINE=MyISAM AUTO_INCREMENT=2015 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
...
INSERT INTO `sys_logininfor` VALUES ('1997', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-14 23:30:11');
INSERT INTO `sys_logininfor` VALUES ('1998', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-15 12:57:08');
INSERT INTO `sys_logininfor` VALUES ('1999', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-09-15 12:58:23');
INSERT INTO `sys_logininfor` VALUES ('2000', 'renshi', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-15 12:58:28');
INSERT INTO `sys_logininfor` VALUES ('2001', 'renshi', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-09-15 12:58:36');
INSERT INTO `sys_logininfor` VALUES ('2002', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-15 12:58:39');
INSERT INTO `sys_logininfor` VALUES ('2003', 'caiwu', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '登录成功', '2022-09-15 12:59:37');
INSERT INTO `sys_logininfor` VALUES ('2004', 'houchu', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '登录成功', '2022-09-15 12:59:49');
INSERT INTO `sys_logininfor` VALUES ('2005', 'houchu', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '退出成功', '2022-09-15 13:00:01');
INSERT INTO `sys_logininfor` VALUES ('2006', 'yuding', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '登录成功', '2022-09-15 13:00:04');
INSERT INTO `sys_logininfor` VALUES ('2007', 'yuding', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '退出成功', '2022-09-15 13:00:14');
INSERT INTO `sys_logininfor` VALUES ('2008', 'dating', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '登录成功', '2022-09-15 13:00:20');
INSERT INTO `sys_logininfor` VALUES ('2009', 'dating', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '退出成功', '2022-09-15 13:11:41');
INSERT INTO `sys_logininfor` VALUES ('2010', 'admin', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '1', '密码输入错误1次', '2022-09-15 13:11:46');
INSERT INTO `sys_logininfor` VALUES ('2011', 'admin', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '登录成功', '2022-09-15 13:11:49');
INSERT INTO `sys_logininfor` VALUES ('2012', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-15 13:38:04');
INSERT INTO `sys_logininfor` VALUES ('2013', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-09-15 14:25:26');
INSERT INTO `sys_logininfor` VALUES ('2014', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-15 14:29:14');
...
CREATE TABLE `sys_menu` (
  ...
  `menu_top_id` bigint(20) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=2333 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
...
CREATE TABLE `sys_menu_top` (
  ...
  `delete_flag` tinyint(4) DEFAULT '0',
  PRIMARY KEY (`menu_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='顶部菜单表';
...
CREATE TABLE `sys_oper_log` (
  ...
  `oper_user_type` int(11) DEFAULT NULL COMMENT '用户类型',
  ...
  `oper_date` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`oper_id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=259 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';

-- ----------------------------
-- Records of sys_oper_log
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES ('256', '个人信息', '2', 'com.study.web.controller.system.SysProfileController.update()', '1', 'admin', '1', '0', '健身俱乐部', '/gym/system/user/profile/update', '127.0.0.1', null, '{\r\n  \"id\" : [ \"\" ],\r\n  \"userName\" : [ \"超级管理员\" ],\r\n  \"phonenumber\" : [ \"17711112222\" ],\r\n  \"email\" : [ \"\" ],\r\n  \"sex\" : [ \"1\" ]\r\n}', '0', null, '2022-09-05 17:18:26', '2022-09-05');
INSERT INTO `sys_oper_log` VALUES ('257', '个人信息', '2', 'com.study.web.controller.system.SysProfileController.updateAvatar()', '1', 'admin', '1', '0', '餐饮有限公司', '/ct/system/user/profile/updateAvatar', '127.0.0.1', null, '{ }', '0', null, '2022-09-14 23:31:46', '2022-09-14');
INSERT INTO `sys_oper_log` VALUES ('258', '个人信息', '2', 'com.study.web.controller.system.SysProfileController.update()', '1', 'admin', '1', '0', '餐饮有限公司', '/ct/system/user/profile/update', '127.0.0.1', null, '{\r\n  \"id\" : [ \"\" ],\r\n  \"userName\" : [ \"超级管理员\" ],\r\n  \"phonenumber\" : [ \"17755895101\" ],\r\n  \"email\" : [ \"\" ],\r\n  \"sex\" : [ \"1\" ]\r\n}', '0', null, '2022-09-14 23:31:48', '2022-09-14');
...
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色信息表';
...
CREATE TABLE `sys_user` (
  ...
  `idcardno` varchar(20) DEFAULT NULL COMMENT '身份证',
  `email` varchar(50) DEFAULT '' COMMENT '用户邮箱',
  `salary` varchar(32) DEFAULT NULL COMMENT '工资',
  `entry_date` varchar(32) DEFAULT NULL COMMENT '入职日期',
  `phonenumber` varchar(32) DEFAULT '' COMMENT '手机号码',
  `sex` char(1) DEFAULT '0' COMMENT '用户性别（0男 1女 2未知）',
  `avatar` varchar(100) DEFAULT '' COMMENT '头像路径',
  `password` varchar(50) DEFAULT '' COMMENT '密码',
  `salt` varchar(20) DEFAULT '' COMMENT '盐加密',
  `status` char(1) DEFAULT '0' COMMENT '帐号状态（0正常 2停用）',
  `user_type` tinyint(4) DEFAULT '0' COMMENT '0俱乐部内部人员，1会员',
  ...
  `delete_by` varchar(64) DEFAULT NULL,
  `delete_time` datetime DEFAULT NULL,
  `delete_flag` tinyint(4) DEFAULT '0' COMMENT '删除标志（0代表存在 1代表删除）',
  `oldpwd` varchar(64) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=12721 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户信息表';

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '100', 'admin', '超级管理员', '0001', '0001', '', null, null, '17755895101', '1', '/profile/avatar/2022/09/14/81343d135f25be1ab3528c9934cce027.png', 'd1cdf661140a87c33fa798c452612c34', '5c3753', '0', '0', '', '2022-03-14 23:43:50', '127.0.0.1', '2022-09-15 14:29:15', '管理员', 'admin', '2022-03-14 23:43:50', 'admin', '2022-09-15 14:29:14', null, null, '0', 'wU6G3AbTqzby88fFF69W1w==', null, null, null);
INSERT INTO `sys_user` VALUES ('12714', '219', 'houchu', '后厨', null, null, '', '5000', '2022-04-13', '', '0', '', 'c4bb0ba935ed0b3bb209b51969556bc4', 'bf7116', '0', '0', null, '2022-04-21 22:21:25', '127.0.0.1', '2022-09-15 12:59:49', '这里是地址', 'admin', '2022-04-21 22:21:25', '', '2022-09-15 12:59:49', null, null, '0', '6sNGZkDV4Zy36rRLW6cqiF0mILiJtVgDvFsddqSylcfGmK4nI+owv3ripvVre8E2', null, null, null);
INSERT INTO `sys_user` VALUES ('12715', '218', 'caiwu', '财务', null, null, '', '4444', '2022-04-21', '', '2', '', '2572f6adac412eade450c57c2d8e89d2', '083dce', '0', '0', null, '2022-04-21 22:32:42', '127.0.0.1', '2022-09-15 12:59:37', null, 'admin', '2022-04-21 22:32:42', '', '2022-09-15 12:59:37', null, null, '0', 'oYYJbPSKbmmKK46BVgDuCpWQI7doETEEqDd8MQU6kDxile39yRxbcbbPzULwp4pn', null, null, null);
INSERT INTO `sys_user` VALUES ('12716', '220', 'yuding', '预订', null, null, '', '5555', '2022-04-21', '', '2', '', '116ccfe7e98da3ff696e918c32995934', '535a23', '0', '0', null, '2022-04-21 22:33:09', '127.0.0.1', '2022-09-15 13:00:04', null, 'admin', '2022-04-21 22:33:09', '', '2022-09-15 13:00:04', null, null, '0', '+ocA9/c+XTwGMMtGoUj/MUZZoCP6rxKQDlCOufeLEhw6PdyRQ3fBXygSF2nJiv5D', null, null, null);
INSERT INTO `sys_user` VALUES ('12717', '220', 'dating', '大厅', null, null, '', '6666', '2022-04-20', '', '2', '', '3be49d26498508462d804637445bbddb', '3b570f', '0', '0', null, '2022-04-21 22:34:00', '127.0.0.1', '2022-09-15 13:00:21', null, 'admin', '2022-04-21 22:34:00', '', '2022-09-15 13:00:20', null, null, '0', 'rbNzWudD14C+UAs4dsl2J+6Zwvmayczng04rJ4FOS4SnYz2cWZ3u9IyhmFiX72FU', null, null, null);
...
INSERT INTO `sys_user` VALUES ('12720', null, 'renshi', '人事', null, null, '', null, null, '', '1', '', '31a569acb4f49b30f461b1aec93b3669', '623dfd', '0', '0', null, '2022-04-22 15:37:45', '127.0.0.1', '2022-09-15 12:58:28', '', 'admin', '2022-04-22 15:37:45', 'renshi', '2022-09-15 12:58:28', null, null, '0', 'ihdb4OOEbRySgTR0IpiannhFvovbZ2qSM3DecLqoctViDrIGx0X4qkmKzrBcfuNR', null, null, null);
...
CREATE TABLE `sys_user_online` (
  ...
  `user_code` varchar(50) DEFAULT '' COMMENT '学工号',
  `idcardno` varchar(50) DEFAULT '' COMMENT '身份证',
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('4ec0f69a-bfa3-42a0-b54b-685893c117af', 'admin', '超级管理员', '0001', '0001', '0', '17755895101', '餐饮有限公司', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', 'on_line', '2022-09-15 13:11:42', '2022-09-15 13:34:26', '604800000');
INSERT INTO `sys_user_online` VALUES ('a54b5d8c-7003-4273-8097-653555c6edc6', 'admin', '超级管理员', '0001', '0001', '0', '17755895101', '餐饮有限公司', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', 'on_line', '2022-09-15 14:25:27', '2022-09-15 14:29:15', '604800000');
